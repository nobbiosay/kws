...
export default function Login(){
  const [operator_id,setId] = useState('operator');
  ...
  return (
    <div className="container">
      <div className="card" style={{maxWidth:480, margin:'60px auto'}}>
        ...
        <p className="subtitle">Gunakan contoh akun: ID <b>operator</b>, Password <b>password</b> (bisa diganti di backend seeder).</p>
