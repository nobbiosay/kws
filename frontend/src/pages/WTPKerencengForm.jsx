...
export default function WTPKerencengForm(){
  ...
  const save = async()=>{
    ...
    await api.post('/entries',{
      date, wtp:'kerenceng', flowmeter, chemicals:chem, electricity, quality, durations, pressure, filters
    });
    setSaving(false);
    alert('Tersimpan');
  };
  ...
  return (
    <Layout>
      <h2 className="title">Input Data WTP Kerenceng</h2>
      <div className="card">
